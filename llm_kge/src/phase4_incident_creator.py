...
class IncidentCreatorSession:
    ...
    def __init__(
        ...
        self.incidents_map = build_incidents_map_from_tsv(INCIDENT_PROPS)
        ...
        # sistema (phase5_eval) sigue usando GPU vía el device por defecto.
        self.model, self.factory = load_model_by_name(kge_model_name, device="cpu")
        # Adaptador inyectado en el motor CBR (lo desacopla del modelo KGE).
        self.kge_scorer = KGEScorer(self.model, self.factory)
